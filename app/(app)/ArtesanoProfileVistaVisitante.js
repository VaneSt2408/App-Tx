...
export default function ArtesanoProfileVistaVisitante() {
  ...
  const checkIfFollowing = useCallback(
    async (artesanoId) => {
      ...
      const isCurrentlyFollowing = await seguidosService.checkIfFollowing(
        session.user.id,
        artesanoId,
      );
  ...
  const loadArtesanoProfile = useCallback(
    async (id, isInitialLoad = false) => {
      try {
  ...
  const handleFollowToggle = async () => {
    ...
    try {
      ...
      if (isFollowing) {
        ...
        result = await seguidosService.unfollowArtesano(
          session.user.id,
          userId,
        );
      } else {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          <Text style={styles.errorText}>
            No se pudo cargar el perfil del artesano.
          </Text>
        </View>
      </SafeAreaView>
    );
      ...
      >
        ...
        <View style={[styles.header, { fontFamily: "Alan Sans" }]}>
          <View style={styles.avatarContainer}>
            {artesano.avatar_url ? (
              <Image
                source={{ uri: artesano.avatar_url }}
                style={styles.avatar}
              />
            ) : (
          ...
          <Text style={[styles.name, { fontFamily: "Alan Sans" }]}>
            {artesano.nombre || "Artesano sin nombre"}
          </Text>
          <Text style={styles.specialty}>
            {artesano.categoria || "Ceramista"}
          </Text>
          ...
          <View style={styles.metricsContainer}>
            <View style={styles.metricCard}>
              <Text style={[styles.metricNumber, { fontFamily: "Alan Sans" }]}>
                {productos.length}
              </Text>
              <Text style={[styles.metricLabel, { fontFamily: "Alan Sans" }]}>
                Productos
              </Text>
            </View>
            <View style={styles.metricCard}>
        ...
        <View style={styles.tabsContainer}>
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "sobreMi" && styles.activeTabText,
                { fontFamily: "Alan Sans" },
              ]}
            >
              Descripción
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "miTrabajo" && styles.activeTabText,
                { fontFamily: "Alan Sans" },
              ]}
            >
              Productos
          ...
          <View style={styles.tabContent}>
            <Text style={[styles.tabContentText, { fontFamily: "Alan Sans" }]}>
              {artesano?.descripcion ||
                "Este artesano aún no ha agregado una descripción."}
            </Text>
